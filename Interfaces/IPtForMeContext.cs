...
namespace Pt_For_Me.Interfaces
{
    public interface IPtForMeContext
    {
        ...
        DbSet<GetClientInfoByUserID_Result> GetClientInfoByUserID_Result { get; set; }
        ...
        DbSet<GetTrainersBySpecialtyKeyword_Result> GetTrainersBySpecialtyKeyword_Result { get; set; }
        DbSet<GetSessionInfoByTrainerID_Result> GetSessionInfoByTrainerID_Result { get; set; }
        DbSet<GetSessionInfoByUserID_Result> GetSessionInfoByUserID_Result { get; set; }
        DbSet<GetTrainerRating_Result> GetTrainerRating_Result { get; set; }
